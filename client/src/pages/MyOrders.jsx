...
import { ChevronDown, ChevronUp, Copy, Loader2Icon } from "lucide-react";
...
const MyOrders = () => {
  ...
  const copy = async (txt) => {
    try {
      await navigator.clipboard.writeText(txt); //copy uses browser clipboard API to save text with feedbac
