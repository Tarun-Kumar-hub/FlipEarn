...
const ListingDetails = () => {
  ...
  // Slider navigation (infinite loop)
  // prevSlide → 0 goes to last, otherwise -1
  // nextSlide → last goes to 0, otherwise +1
    ...
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex items-start max-md:flex-col gap-10">
        <div className="flex-1 max-md:w-full">
          ...
          <div className="bg-white rounded-xl border border-gray-200 mb-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 p-4 text-sm">
              <div>
      ...
      <div className="bg-white border-t border-gray-200 p-4 text-center mt-28">
        <p className="text-sm text-gray-500">
          ...
          <span className="text-indigo-600">flipearn</span>. All rights
          reserved.
        </p>
      </div>
    </div>
